...
replace (
	...
	github.com/rancher/types => github.com/shanewxy/types v0.0.0-20200206042210-ffcbf2dd8e3d
...
require (
	...
	github.com/rancher/dynamiclistener v0.2.1-0.20200204194956-ece289ed54b1
